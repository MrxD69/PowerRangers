 ...
 */
final class Version20241219023253 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commande_db (id INT AUTO_INCREMENT NOT NULL, freelancer_id INT NOT NULL, prix NUMERIC(10, 2) NOT NULL, description LONGTEXT NOT NULL, technologie VARCHAR(255) NOT NULL, datefin DATETIME NOT NULL, INDEX IDX_DE27F52C8545BDF5 (freelancer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reclamation (id INT AUTO_INCREMENT NOT NULL, project_db_id INT DEFAULT NULL, freelancer_id INT DEFAULT NULL, client_id INT DEFAULT NULL, complainant_id INT NOT NULL, against_user_id INT NOT NULL, commande_db_id INT DEFAULT NULL, date DATE NOT NULL, etat VARCHAR(255) NOT NULL, message VARCHAR(255) NOT NULL, INDEX IDX_CE606404B1EA0CA4 (project_db_id), INDEX IDX_CE6064048545BDF5 (freelancer_id), INDEX IDX_CE60640419EB6921 (client_id), INDEX IDX_CE6064044C422040 (complainant_id), INDEX IDX_CE606404A70F11BA (against_user_id), INDEX IDX_CE6064049BD7DAF9 (commande_db_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
